 ...
 */
package com.aperigeek.jlad.web.servlet;
 ...
 */
@WebServlet(name = "DetectionServlet", urlPatterns = {"/detect.srv"})
public class DetectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher d = request.getRequestDispatcher("/detectionResult.jsp");
